...
class MovieRecommender:
    ...
    def _build_title_index(self):
        """Rebuild title lookup dictionary"""
        self._title_to_idx = {}
    ...
    def load(self, bundle: dict):
        """Restore recommender from joblib bundle"""
        self.df = bundle["df"]
        self.X = bundle["X"]
        self.art = bundle["art"]
        self.nn = bundle["nn"]

        # ✅ Rebuild lookup after loading
        self._build_title_index()
        return self
    ...
    def recommend(
      ...
      year_range: tuple[int,int] | None = None
        ...
        # Query more than k to allow filtering
